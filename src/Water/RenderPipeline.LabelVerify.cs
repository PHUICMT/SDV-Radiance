...
namespace SDVRadiance
{
    ...
    internal sealed partial class RenderPipeline
    {
        ...
        public void DrawDebugOverlay(SpriteBatch spriteBatch)
        {
            ...
            if (DebugChannel == DebugOverlayChannel.Normals)
                Utility.drawTextWithShadow(spriteBatch,
                    $"sway strips {FoliageSway.StripDrawsThisFrame}   crops leaned {FoliageSway.CropSwaysThisFrame}   grass moved {FoliageSway.GrassSwaysThisFrame}   upscaled draws {SheetUpscaler.RedirectedThisFrame} ({SheetUpscaler.PatchedOverloads} overloads)   {SheetUpscaler.Cache.Describe()}   {SheetUpscaler.SoftSprites.Describe()}",
