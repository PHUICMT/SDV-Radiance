...
namespace SDVRadiance.Integrations
{
    ...
    public interface IGenericModConfigMenuApi
    {
        ...
        void AddKeybindList(StardewModdingAPI.IManifest mod, Func<StardewModdingAPI.Utilities.KeybindList> getValue, Action<StardewModdingAPI.Utilities.KeybindList> setValue, Func<string> name, Func<string>? tooltip = null, string? fieldId = null);
